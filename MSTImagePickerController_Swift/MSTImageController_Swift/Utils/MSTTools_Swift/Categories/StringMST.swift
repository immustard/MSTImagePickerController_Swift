...
internal extension String {
    ...
    func mst_textHeight(maxWidth width: CGFloat, font: UIFont) -> CGFloat {
        let rect: CGRect = NSString(string: self).boundingRect(with: CGSize(width: width, height: CGFloat.greatestFiniteMagnitude), options: .usesDeviceMetrics, attributes: [NSAttributedStringKey.font: font], context: nil)
    ...
    func mst_textWidth(maxHeight height: CGFloat, font: UIFont) -> CGFloat {
        let rect: CGRect = NSString(string: self).boundingRect(with: CGSize(width: CGFloat.greatestFiniteMagnitude, height: height), options: .usesDeviceMetrics, attributes: [NSAttributedStringKey.font: font], context: nil)
